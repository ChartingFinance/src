...
const METRIC_DESCRIPTIONS = {
    ...
    [Metric.MAINTENANCE]:                 'Assets that require frequent maintence, like houses or boats',
    [Metric.INSURANCE]:                   'Assets that require insurance, like houses and boats',
    [Metric.PROPERTY_TAX]:                'Annual property tax on real estate, assessed monthly.',
    [Metric.PRETAX_CONTRIBUTION]:         'All pre-tax contributions to tax deferred accounts',
    [Metric.POSTTAX_CONTRIBUTION]:        'All contributions after tax calculation',
    ...
    [Metric.TAX_FREE_DISTRIBUTION]:       'Cash distribution without tax liability',
