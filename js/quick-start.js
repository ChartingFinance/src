    ...
    assets(d) {
        return [
            ...
            { instrument: '401K', displayName: '401K',
              startDateInt: d.now,
              startCurrency: { amount: 45000 }, annualReturnRate: { rate: 0.09 } },
            { instrument: 'rothIRA', displayName: 'Roth IRA',
              startDateInt: d.now,
              startCurrency: { amount: 15000 }, annualReturnRate: { rate: 0.09 } },
...
const MID_CAREER = {
    ...
    assets(d) {
        return [
            ...
            { instrument: '401K', displayName: '401K',
              startDateInt: d.now,
              startCurrency: { amount: 100000 }, annualReturnRate: { rate: 0.09 } },
            { instrument: 'rothIRA', displayName: 'Roth IRA',
              startDateInt: d.now,
              startCurrency: { amount: 50000 }, annualReturnRate: { rate: 0.09 } },
            { instrument: 'taxableEquity', displayName: 'Brokerage',
              startDateInt: d.now,
...
const PRE_RETIREMENT = {
    ...
    assets(d) {
        return [
            ...
            { instrument: '401K', displayName: '401K',
              startDateInt: d.now,
              startCurrency: { amount: 350000 }, annualReturnRate: { rate: 0.08 } },
            { instrument: 'ira', displayName: 'IRA',
              startDateInt: d.now,
              startCurrency: { amount: 120000 }, annualReturnRate: { rate: 0.08 } },
            { instrument: 'rothIRA', displayName: 'Roth IRA',
              startDateInt: d.now,
              startCurrency: { amount: 80000 }, annualReturnRate: { rate: 0.08 } },
            { instrument: 'taxableEquity', displayName: 'Brokerage',
              startDateInt: d.now,
              startCurrency: { amount: 100000 }, startBasisCurrency: { amount: 55000 },
              annualReturnRate: { rate: 0.08 } },
            { instrument: 'monthlyExpense', displayName: 'Living Expenses',
              startDateInt: d.now,
...
const RETIRED = {
    ...
    assets(d) {
        return [
            ...
            { instrument: 'ira', displayName: 'IRA',
              startDateInt: d.now,
              startCurrency: { amount: 200000 }, annualReturnRate: { rate: 0.07 } },
            { instrument: 'rothIRA', displayName: 'Roth IRA',
              startDateInt: d.now,
              startCurrency: { amount: 150000 }, annualReturnRate: { rate: 0.07 } },
            { instrument: 'taxableEquity', displayName: 'Brokerage',
              startDateInt: d.now,
